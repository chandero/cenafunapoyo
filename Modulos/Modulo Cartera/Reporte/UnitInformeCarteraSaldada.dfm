object frmInformeCarteraSaldada: TfrmInformeCarteraSaldada
  Left = 509
  Top = 240
  Width = 342
  Height = 145
  Caption = 'Informe Cartera Saldada En Rango de Fechas'
  Color = clBtnFace
  ...
  object GroupBox1: TGroupBox
    ...
    Width = 321
    Height = 65
    Caption = 'Pagar'#233' Saldado En El Periodo'
    TabOrder = 0
    ...
    object edFechaInicial: TDateTimePicker
      ...
      Date = 43500.7174806366
      Time = 43500.7174806366
      DateFormat = dfShort
      DateMode = dmComboBox
      Kind = dtkDate
      ParseInput = False
    ...
    object edFechaFinal: TDateTimePicker
      ...
      Height = 21
      CalAlignment = dtaLeft
      Date = 43500.7176152546
      Time = 43500.7176152546
      DateFormat = dfShort
      DateMode = dmComboBox
      Kind = dtkDate
      ParseInput = False
  ...
  object IBQuery1: TIBQuery
    SQL.Strings = (
        ...
        'SELECT c.ID_PERSONA, p.NOMBRE, p.PRIMER_APELLIDO, p.SEGUNDO_APEL' +
        'LIDO, c.ID_COLOCACION FROM "col$colocacion" c '
      
        'LEFT JOIN "gen$persona" p ON p.ID_IDENTIFICACION = c.ID_IDENTIFI' +
        'CACION and p.ID_PERSONA = c.ID_PERSONA'
      'WHERE'
      'c.FECHA_SALDADO BETWEEN :FECHA_INICIAL and :FECHA_FINAL'
