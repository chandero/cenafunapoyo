...
type
  TfrmMain = class(TForm)
    ...
    BalanceGeneralDetalladoExcel1: TMenuItem;
    ...
    procedure BalanceGeneralDetalladoExcel1Click(Sender: TObject);
  private
...
uses unitLogin, IniFiles,
     ...
     UnitSumatorias, UnitRecuperarLiquidacioncolocacion, UnitCambiarContrasena,
     //UnitControlCobroCartera,
     ...
     UnitBalanceConsolidadoTxt, UnitExportarSaldos, UnitCambios,
     UnitInformeEstadoIngresosGastos, UnitBalanceGralDetalladoAnyo;
...
begin
  ...
  try
    ...
    DBAnho := ReadInteger('EMPRESA','Anho', 2018);
...
var frmBalanceGralDetalladoAnyo:TfrmBalanceGralDetalladoAnyo;
begin
        frmBalanceGralDetalladoAnyo := TfrmBalanceGralDetalladoAnyo.Create(Self);
        frmBalanceGralDetalladoAnyo.ShowModal;
end;

procedure TfrmMain.BalanceGeneralDetalladoExcel1Click(Sender: TObject);
var
