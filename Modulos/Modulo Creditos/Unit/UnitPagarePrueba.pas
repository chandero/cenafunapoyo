...
begin
        ...
        if ParName = 'EN_NUMERO' then
         ...
         begin
           ...
           SQL.Add('where ID_COLOCACION = :ID_COLOCACION and CAPITAL_A_PAGAR <> 0');
           ParamByName('ID_COLOCACION').AsString := EdColocacion.Text;
           try
             ExecQuery;
           except
       ...
       begin
           ...
           IBSQL1.SQL.Add('where ID_COLOCACION = :ID_COLOCACION and CAPITAL_A_PAGAR <> 0');
...
begin
        ...
        IBSQL1.SQL.Clear;
        IBSQL1.SQL.Add('SELECT COUNT(*) AS TOTAL FROM "col$tablaliquidacion" WHERE ID_COLOCACION = :ID_COLOCACION');
        ...
        IBSQL2.SQL.Add('WHERE "col$colocacion".ID_COLOCACION = :ID_COLOCACION');
        ...
        CalcularDescuentoPorCuota(CDSCuotas,CDSDescuento, CDSADescontar,  vDesembolso, AmK, vDesembolso);
