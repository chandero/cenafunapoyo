object FrmSolicitudAsesor: TFrmSolicitudAsesor
  Left = 410
  Top = 218
  Width = 434
  Height = 129
  ...
  object IBanalisis: TIBQuery
    ...
    SQL.Strings = (
      ...
      '  "col$solicitud" s'
        ...
        'LEFT JOIN SOLICITUDASESOR sa ON sa.ID_AGENCIA = s.OFICINA and sa' +
        '.ID_SOLICITUD = s.ID_SOLICITUD'
      'INNER JOIN ASESOR a ON a.ASES_ID = sa.ASES_ID'
      ...
      '  (e.ID_EMPLEADO = :ID_EMPLEADO) AND'
        ...
        'FIN)'
      'ORDER BY e.ID_EMPLEADO, s.ESTADO, s.ID_SOLICITUD')
    Left = 336
    ParamData = <
      item
        DataType = ftUnknown
