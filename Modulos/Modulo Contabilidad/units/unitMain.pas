...
type
  TfrmMain = class(TForm)
    ...
    AuxiliardeTerceros1: TMenuItem;
    ConsultaComprobantes1: TMenuItem;
    PorCentro1: TMenuItem;
    Ingresos1: TMenuItem;
    ...
    procedure AuxiliardeTerceros1Click(Sender: TObject);
...
uses unitLogin, IniFiles,
     ...
     unitCdatporEdades,UnitCausacionCdat,UnitBarridoAhoApo,
...
begin
        Self.Caption := 'Módulo Contable - ' + DBserver + ':' + DBpath + DBname  + ' - ' + Empresa;
        if SalirMal then
           Self.Close;
end;
...
procedure TfrmMain.AuxiliardeTerceros1Click(Sender: TObject);
var
...
procedure TfrmMain.ConsultaComprobantes1Click(Sender: TObject);
var
...
begin
        frmInformeIngresosGastosporCentro := TfrmInformeIngresosGastosporCentro.Create(self);
        frmInformeIngresosGastosporCentro.ShowModal;
end;

procedure TfrmMain.BalanceGeneralporCentro1Click(Sender: TObject);
var
   frmInformeBalanceGeneralporCentro: TfrmInformeBalanceGeneralporCentro;
begin
     frmInformeBalanceGeneralporCentro := TfrmInformeBalanceGeneralporCentro.Create(self);
     frmInformeBalanceGeneralporCentro.ShowModal;
end;
...
begin
     frmAuxiliarCentro := TfrmAuxiliarCentro.Create(self);
     frmAuxiliarCentro.ShowModal;
end;

procedure TfrmMain.RecaudodeCartera1Click(Sender: TObject);
var
...
begin
        frmBalanceGralDetalladoAnho := TfrmBalanceGralDetalladoAnyo.Create(Self);
