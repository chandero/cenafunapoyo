...
type
  TfrmPlantilla = class(TForm)
    ...
    IBQDetallePLDE_CODIGO: TIBStringField;
    IBQDetalleNOMBRE: TIBStringField;
    IBQDetallePLDE_CREDITO: TIBBCDField;
    IBQDetallePLDE_DEBITO: TIBBCDField;
    IBQDetallePLDE_ID_IDENTIFICACION: TIntegerField;
    IBQDetallePLDE_ID_PERSONA: TIBStringField;
    IBQDetallePERSONA: TIBStringField;
    IBQDetallePLDE_NUMERO_CUENTA: TIBStringField;
    IBQDetallePLDE_ID_COLOCACION: TIBStringField;
    IBQDetallePLDE_MONTO: TIBBCDField;
    IBQDetallePLDE_TASA: TFloatField;
