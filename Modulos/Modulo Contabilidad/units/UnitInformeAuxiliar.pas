...
begin
        With IBQuery1 do
         begin
           ...
           SQL.Add('"con$auxiliarext".DETALLE AS DESCRIPCION,');
           ...
           SQL.Add('LEFT JOIN "con$auxiliarext" ON ("con$auxiliar".ID = "con$auxiliarext".ID) ');
...
begin
    ...
    begin
        ...
        if (IBQuery1.FieldByName('DESCRIPCION').IsNull) or (trim(IBQuery1.FieldByName('DESCRIPCION').AsString) = '') then
