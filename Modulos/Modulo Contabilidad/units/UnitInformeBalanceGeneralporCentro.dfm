object frmInformeBalanceGeneralporCentro: TfrmInformeBalanceGeneralporCentro
  Left = 427
  Top = 249
  Width = 411
  Height = 238
  Caption = 'Balance General por Centro de Costo'
  Color = clBtnFace
  ...
  object IBQpuc: TIBQuery
    ...
    SQL.Strings = (
        ...
        'SELECT  *  FROM  "con$puc"  p WHERE p.CODIGO BETWEEN '#39'1000000000' +
        '00000000'#39' AND '#39'899999999999999999'#39
