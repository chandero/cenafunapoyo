object frmComprobanteC: TfrmComprobanteC
  ...
  object IBQinsauxiliarext: TIBQuery
    SQL.Strings = (
      
        'INSERT INTO "con$auxiliarext" (ID, DETALLE, CHEQUE,ID_COMPROBANT' +
        'E, TIPO_COMPROBANTE,ID_AGENCIA) VALUES (:ID,:DETALLE,:CHEQUE,:ID' +
        '_COMPROBANTE,:TIPO_COMPROBANTE,:ID_AGENCIA)')
    Left = 160
    Top = 496
    ParamData = <
      item
