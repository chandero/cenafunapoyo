...
begin
        ...
        IBSQLIva.Database := dmGeneral.IBDatabase1;
        IBSQLCodigo.Database := dmGeneral.IBDatabase1;
        IBSQLcierre.Database := dmGeneral.IBDatabase1;
        IBSQLcierre1.Database := dmGeneral.IBDatabase1;
        IBQRepnormal.Database := dmGeneral.IBDatabase1;
        IBQRepanormal.Database := dmGeneral.IBDatabase1;
        IBVerificarcap.Database := dmGeneral.IBDatabase1;
        Querycompcierre.Database := dmGeneral.IBDatabase1;
        Queryauxcierre.Database := dmGeneral.IBDatabase1;
        _bOpcion := False;
