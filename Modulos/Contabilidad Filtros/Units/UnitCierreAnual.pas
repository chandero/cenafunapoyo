...
begin
        ...
        Cansecutivo := ObtenerConsecutivo(IBSQL1,1);
        ...
        begin
          ...
          movimiento := 0;
             ...
             CDsaldos.FieldValues['nombre'] := EdNombre.Caption;
             CDsaldos.FieldValues['debito'] := debito;
             CDsaldos.FieldValues['credito'] := credito;
             CDsaldos.Post;
        ...
        NoComprobante.Caption := Format('%.5d',[cansecutivo]);
end;
...
begin
        ...
        with IBSQL1 do begin
         ...
         if RecordCount > 0 then
            ...
            EdNombre.Caption := 'NO SE ENCONTRO CODIGO';
        end;
