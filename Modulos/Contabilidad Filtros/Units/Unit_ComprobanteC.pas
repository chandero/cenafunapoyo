...
uses
  ...
  // Propias
  UnitPlandeCuentas , UnitPlantillas, ComCtrls, UnitdmGeneral
  ;
...
uses UnitPersona,
Unit_buscarcomprobante,unit_Dmpuc, UnitGlobales;
...
begin
        ...
        begin
          ...
          id_agencia:= unitGlobales.Agencia;
      ...
      _query2.Transaction := _transaccion;
        ...
        with _query do
            begin
                ...
                Open;
                id_tipocomprobante := FieldByName('TIPO_COMPROBANTE').AsInteger;
...
var
   frmPUC: TfrmPlandeCuentas;
begin
        frmPUC := TfrmPlandeCuentas.Create(self);
