...
type
  TfrmMain = class(TForm)
    ...
    procedure SolicitudporAsesor1Click(Sender: TObject);
...
uses unitLogin, unitdmGeneral, unitdmColocacion, IniFiles,
  ...
  UnitDesembolsoTmp, UnitVisarDesembolsoTmp, UnitPlanillaConsolidada, UnitInformeSolicitudAsesor;
...
procedure TfrmMain.SolicitudporAsesor1Click(Sender: TObject);
var
  frmSolicitudAsesor : TfrmSolicitudAsesor;
begin
        frmSolicitudAsesor := TfrmSolicitudAsesor.Create(self);
        frmSolicitudAsesor.ShowModal;
end;
