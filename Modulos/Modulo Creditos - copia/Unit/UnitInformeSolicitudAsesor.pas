unit UnitInformeSolicitudAsesor;
...
uses
  ...
  JvDbPrgrss, DBTables, IBExtract, sdXmlDocuments,
  UnitdmGeneral;

type
  TFrmSolicitudAsesor = class(TForm)
    Panel1: TPanel;
    Label1: TLabel;
...
var
  FrmSolicitudAsesor: TFrmSolicitudAsesor;
...
procedure TFrmSolicitudAsesor.FormCreate(Sender: TObject);
begin
...
procedure TFrmSolicitudAsesor.BitBtn1Click(Sender: TObject);
begin
...
procedure TFrmSolicitudAsesor.BitBtn2Click(Sender: TObject);
begin
        Close;
end;

procedure TFrmSolicitudAsesor.imprimir_reporte(cadena: string);
begin
...
procedure TFrmSolicitudAsesor.frReport1GetValue(const ParName: String;
  var ParValue: Variant);
begin
...
procedure TFrmSolicitudAsesor.solicitud_aprobada;
begin
...
procedure TFrmSolicitudAsesor.JVPercentChange(Sender: TObject;
  PercentDone: Integer);
begin
        ShowMessage(IntToStr(PercentDone));
end;

function TFrmSolicitudAsesor.IsDuplicate(DBName: string): string;
var
...
procedure TFrmSolicitudAsesor.Button1Click(Sender: TObject);
begin
        ShowMessage(isduplicate(dmGeneral.IBDatabase1.DatabaseName));
end;

procedure TFrmSolicitudAsesor.SolicitudAgencia(puerto,id_agencia: Integer;host_r,DesAgecnia: string);
...
procedure TFrmSolicitudAsesor.solicitudes;
...
procedure TFrmSolicitudAsesor.FormClose(Sender: TObject;
