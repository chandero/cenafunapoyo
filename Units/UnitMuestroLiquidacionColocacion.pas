...
uses
  ...
  JvEdit, JvTypedEdit, IBStoredProc, unitFacturar;
...
>>>>>>> 171925b3cf59501bab9dd1664befb26ff80c6cee
  ...
  public
    ...
    property Agencia: Integer read MyAgencia Write MyAgencia;
    property AgenciaDescripcion: String read MyAgenciaDescripcion Write MyAgenciaDescripcion;
...
>>>>>>> 171925b3cf59501bab9dd1664befb26ff80c6cee
    ...
    property AbonoSobrante:Currency read MyAbonoSobrante Write MyAbonoSobrante;
    { Public declarations }
  end;
...
uses  UnitVistaPreliminar,
     UnitGlobalesCol, UnitGlobales, wsdl_conexus;
...
begin
        ...
        for I := 0 to (MyLista.Count - 1) do
         begin
           ...
           edColocacion.Text := Colocacion;
           EdCentro.Text := AgenciaDescripcion;
           EdSaldoAnterior.Caption := FormatCurr('#,#0',vSaldoActual);
           EdCapital.Caption:= FormatCurr('#,#0',Capital);
           edSobrante.Caption := FormatCurr('#,#0',AbonoSobrante);
...
//           votrospagos := 0;
           ...
           saldo := vSaldoactual - (Capital-AbonoSobrante);
...
//      SQL.Add('"col$colocacion".ID_ESTADO_COLOCACION =:"ID_ESTADO_COLOCACION"');
      ...
      ParamByName('ID_AGENCIA').AsInteger := Agencia;
      ParamByName('ID_COLOCACION').AsString := Colocacion;
      ParamByName('ABONOS_CAPITAL').AsCurrency := (Capital - AbonoSobrante);
...
>>>>>>> 171925b3cf59501bab9dd1664befb26ff80c6cee
            ...
            ParamByName('ID_CLASE_OPERACION').AsString := AR^.Id_Clase_Operacion;
            ExecSQL;
            ...
            ParamByName('ID').AsInteger := idauxiliar;
            if Nacional then
                   ParamByName('DETALLE').AsString := 'Descuento de Cartera por Pagaré No.' + Colocacion + ' ' + 'Consig. Nal' + ' ' + DateToStr(FechaConsignacion)
            else
                   ParamByName('DETALLE').AsString := 'Descuento de Cartera por Pagaré No.' + Colocacion;
...
//***fin actualizo extracto
       ...
       begin
         ...
         MessageDlg('Error al Abonar Cuotas: ' + e.Message,mtInformation,[mbOK],0);
         Exit;
       end;
     end;
...
>>>>>>> 171925b3cf59501bab9dd1664befb26ff80c6cee
                       ...
                       begin
                          ...
                          _valor := _valorFacturarANT - _valorFacturarDEV;
                          if (_valor < 0) then _valor := 0;
                          ParamByName('FAIT_VALORUNITARIO').AsCurrency := _valor;
...
<<<<<<< HEAD
                       ...
                       begin
                         SQL.Clear;
                         SQL.Add('INSERT INTO FACTURA_LSNOTA (FACT_NUMERO, FALN_CONSECUTIVO, FALN_DESCRIPCION) VALUES (:FACT_NUMERO, :FALN_CONSECUTIVO, :FALN_DESCRIPCION)');
                         ParamByName('FACT_NUMERO').AsInteger := _vFacturaConsecutivo;
                         ParamByName('FALN_CONSECUTIVO').AsInteger := 1;
...
//                   TasaLiquidacion := SumTasa / SumDias;
        ...
        with IBQuery1 do
         begin
          ...
          ParamByName('ABONO_CAPITAL').AsCurrency := abono_capital - descuento_capital - AbonoSobrante;
...
procedure TfrmMuestroLiquidacionColocacion.Facturar;
var
  _facturar: TFacturar;
begin
...
begin
        ...
        IBSQLAux.Transaction := IBTransaction2;
