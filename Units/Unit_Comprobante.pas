...
type
  ...
  private
    ...
    procedure buscarcomprobante(ID_COMPROBANTE: integer; TIPO_COMPROBANTE:Integer);
    procedure BuscarComp(Id, Tp: Integer);
...
begin
        ...
        begin
          ...
          tipo_comprobante := frmbuscarcomprobante.dblcbtipo.KeyValue;
          frmBuscarcomprobante.Free;
          buscarcomp(id_comprobante,tipo_comprobante);
        end;
end;
...
procedure Tfrmcomprobante.buscarcomprobante(ID_COMPROBANTE: integer; TIPO_COMPROBANTE:integer);
var
auxiliar:integer;
Arecord:Plist;
begin
        with dmcomprobante.IBQuery1 do
            begin
                ...
                SQL.Add('and "con$comprobante"."TIPO_COMPROBANTE" =:"TIPO_COMPROBANTE"');
...
procedure TfrmComprobante.BuscarComp(Id, Tp: Integer);
begin
          with dmcomprobante.IBQuery1 do
          begin
           if Transaction.InTransaction then
           ...
           SQL.Add(' where "con$comprobante".ID_COMPROBANTE = :"ID_COMPROBANTE" AND "con$comprobante".TIPO_COMPROBANTE = :"TIPO_COMPROBANTE"');
           ...
           if dmcomprobante.IBQuery1.RecordCount > 0 then
             begin
              buscarcomprobante(id_comprobante,tipo_comprobante);
//              vmodificar:= true;
