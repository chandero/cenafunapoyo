...
<<<<<<< HEAD
            frmPantallaProgreso.InfoLabel := 'Procesando Causaciï¿½n de Colocaciones';
=======
...
<<<<<<< HEAD
                    MessageDlg('Error al Buscar Datos Para Aplicar Provisiï¿½n',mtError,[mbcancel],0);
=======
...
Begin
  ...
  Reporte.Title := 'Calificaciï¿½n,Causaciï¿½n y Provisiï¿½n de Colocaciones';
...
While Not Eof Do
  Begin
    frmPantallaProgreso.InfoLabel := 'Aplicando Calificaciï¿½n:' + FieldByName('ID_COLOCACION').AsString;
    frmPantallaProgreso.Position :=  RecNo;
    Application.ProcessMessages;
...
End;
MessageDlg('Calificaciï¿½n Aplicada con Exito!',mtInformation,[mbok],0);
...
<<<<<<< HEAD
     ReporteD.Title := 'Calificaciï¿½n y Provisiï¿½n de Colocaciones';
=======
...
<<<<<<< HEAD
  SD1.Title := 'Nombre Para El Archivo de Provisiï¿½n';
  If (SD1.Execute) Then
    Begin
      ...
      ExcelFile.WriteFile;
      ExcelFile.Free;
      ShowMessage('Archivo de Provisiï¿½n Guardado...!');
    End
  Else
    Begin
...
{
=======
          SD1.Title := 'Nombre Para El Archivo de Provisión';
          if (SD1.Execute) then
          begin
           IBQuery1.Filtered := False;
           IBQuery1.Open;
...
begin
              ...
              with IBSQL1 do begin
                ...
                while not Eof do begin
                 ...
                 IBSQL2.SQL.Add('from "col$causaciondiaria"');
                 IBSQL2.SQL.Add('where ID_CLASIFICACION = :ID_CLASIFICACION and ');
                 IBSQL2.SQL.Add('ID_EDAD_ACT = :ID_CATEGORIA and');
                 IBSQL2.SQL.Add('FECHA_CORTE = :FECHA_CORTE');
                 IBSQL2.ParamByName('ID_CLASIFICACION').AsInteger := FieldByName('ID_CLASIFICACION').AsInteger;
                 IBSQL2.ParamByName('ID_CATEGORIA').AsString := FieldByName('ID_EDAD').AsString;
                 IBSQL2.ParamByName('FECHA_CORTE').AsDate := EdFechaCorte.Date;
...
procedure TfrmCausacionCarteraDiaria.CuartoPC;
var AR:PList;
    ValorContable,ValorProvision:Currency;
    Codigo,CodigoI,CodigoE:string;
    Comercial,Consumo,Vivienda,Microcredito:Currency;
    Aplica :Boolean;
begin
...
Procedure TfrmCausacionCarteraDiaria.SextoPC; // ProvisiÃ³n General
...
Begin
  ...
  frmPantallaProgreso.Titulo := 'Aplicando Descuento de Garantï¿½as Reales';
  frmPantallaProgreso.Position := 0;
  frmPantallaProgreso.Ejecutar;
      ...
      If SaldoGarantia > 0 Then
        Begin
          ...
          Try
            Open;
          Except
            MessageDlg('Error al Buscar Fianzas para Aplicar Descuento de Garantï¿½a',mtError,[mbcancel],0);
            Transaction.Rollback;
            raise;
            Exit;
        End;
...
frmPantallaProgreso.Min := 0;
frmPantallaProgreso.Max := CDReal.RecordCount;
frmPantallaProgreso.Titulo := 'Actualizando Garantï¿½as Reales';
frmPantallaProgreso.Position := 0;
frmPantallaProgreso.Ejecutar;
...
Begin
  With IBQuery1 Do
    Begin
      ...
      // Establezco periodo final aï¿½o anterior
      ...
      frmPantallaProgreso.Min := 0;
      frmPantallaProgreso.Max := Total;
      frmPantallaProgreso.Titulo := 'Calculando Provisiï¿½n...';
      frmPantallaProgreso.Position := 0;
      frmPantallaProgreso.Ejecutar;
      ...
      Try
        Open;
        frmPantallaProgreso.Titulo := 'Calculando Provisiï¿½n ...'+'- Leyendo Colocaciones';
      Except
        MessageDlg('Error al Iniciar la Tabla Temporal para el Segundo proceso',mtError,[mbcancel],0);
        Transaction.Rollback;
        raise;
    ...
    Begin
      ...
      With IBSQL3 Do
        Begin
          ...
          Try
            ExecQuery;
            frmPantallaProgreso.Titulo := 'Calculando Provisiï¿½n ...'+'- Leyendo Porcentajes Provisiï¿½n';
          Except
            MessageDlg('Error al Buscar Datos Para Aplicar Provisiï¿½n',mtError,[mbcancel],0);
            frmPantallaProgreso.Cerrar;
            raise;
  ...
  frmPantallaProgreso.Titulo := 'Calculando Provision Aï¿½o Anterior';
  IBSQL6.Close;
  IBSQL6.SQL.Clear;
...
frmPantallaProgreso.Max := Total;
frmPantallaProgreso.Position := 0;
frmPantallaProgreso.InfoLabel := 'Procesando Anticipados Causaciï¿½n de Colocaciones';
While Not IBQuery1.Eof Do
  Begin
    frmPantallaProgreso.Position := IBQuery1.RecNo;
    Application.ProcessMessages;
...
begin
        ...
        begin
            Close;
            SQL.Clear;
            SQL.Add('SELECT c.ID_COLOCACION, c.ID_CLASIFICACION, c.ID_GARANTIA, c.AMORTIZA_INTERES, t.ID_ESTADO_COLOCACION, t.ID_LINEA, c.FECHA_INTERES, c.FECHA_DESEMBOLSO, t.DIAS_PAGO, c.TIPOC_INTERES FROM "col$causaciondiariatmp" c ');
            SQL.Add('INNER JOIN "col$colocacion" t ON c.ID_COLOCACION = t.ID_COLOCACION WHERE c.FECHA_CORTE = :FECHA_CORTE');
            ParamByName('FECHA_CORTE').AsDate := EdFechaCorte.Date;
            Open;
            Last;
...
=======
                ...
                IBSQL4.Close;
                IBSQL4.SQL.Clear;
                IBSQL4.SQL.Add('UPDATE "col$causaciondiariatmp" c SET c.DIAS = :DIAS, c.MOROSIDAD = :MOROSIDAD , c.ID_EDAD_ACT = :EDAD, c.ID_ARRASTRE = :EDAD WHERE c.ID_COLOCACION = :ID_COLOCACION');
                IBSQL4.ParamByName('ID_COLOCACION').AsString := IBQuery1.FieldByName('ID_COLOCACION').AsString;
                IBSQL4.ParamByName('DIAS').AsInteger := DiasCorrientes;
                IBSQL4.ParamByName('MOROSIDAD').AsInteger := DiasMora;
                IBSQL4.ParamByName('EDAD').AsString := Edad;
