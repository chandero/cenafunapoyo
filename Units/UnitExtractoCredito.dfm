object frmExtractoCredito: TfrmExtractoCredito
  ...
  object Extracto: TClientDataSet
    ...
    Top = 368
    Data = {
      500100009619E0BD01000000180000000E000000000003000000500105464543
      ...
      
      46454348415F434F4E5304000600000000000000}
    ...
    object ExtractoDIAS_MORA: TIntegerField
      FieldName = 'DIAS_MORA'
    end
  ...
  object IBQExtractoDet: TIBQuery
    SQL.Strings = (
      
        'SELECT SUM(e.DIAS_APLICADOS) AS DIAS FROM "col$extractodet" e WH' +
        'ERE'
      
        'e.CODIGO_PUC = :CODIGO_PUC and e.ID_COLOCACION = :ID_COLOCACION ' +
        'and e.ID_CBTE_COLOCACION = :ID_CBTE_COLOCACION and e.FECHA_EXTRA' +
        'CTO = :FECHA_EXTRACTO')
    Left = 112
    Top = 312
    ParamData = <
  ...
  object PopupMenu1: TPopupMenu
    Left = 16
    Top = 288
    object AnularAbono1: TMenuItem
      Caption = 'Anular Abono'
      OnClick = AnularAbono1Click
    end
  end
