object FrmInformacion: TFrmInformacion
  ...
  object Pagina: TPageControl
    ...
    object TSolicitante: TTabSheet
      ...
      object Pagina1: TPageControl
        ...
        object TabSheet1: TTabSheet
          ...
          object JvGroupBox3: TJvGroupBox
            ...
            object DBLCBsolicitudtipo: TDBLookupComboBox
              Left = 92
              Top = 41
              Width = 285
              Height = 21
              Color = clWhite
              KeyField = 'SOTI_ID'
              ListField = 'SOTI_DESCRIPCION'
              ListSource = DSsolicitudtipo
              TabOrder = 6
            end
          end
        ...
        object TabAdjuntos: TTabSheet
          ...
          object Panel13: TPanel
            ...
            Height = 171
            TabOrder = 0
            object DBAdjunto: TDBGrid
              Left = 1
              Top = 1
              Width = 611
              Height = 169
              Align = alClient
              DataSource = DSAdjunto
              TabOrder = 0
              TitleFont.Charset = DEFAULT_CHARSET
              TitleFont.Color = clBlack
              TitleFont.Height = -11
          ...
          object Panel14: TPanel
            ...
            object btnAgregarAdjunto: TBitBtn
              Left = 424
              Top = 4
              Width = 90
              Height = 25
              Caption = '&Agregar'
              TabOrder = 1
              OnClick = btnAgregarAdjuntoClick
              Glyph.Data = {
                36050000424D3605000000000000360400002800000010000000100000000100
                08000000000000010000030F0000030F000000010000000100000094000000C6
                0000319C42004A524A00429C4A0052525200527352005A5A5A00635A5A005AAD
            ...
            object btnEliminarAdjunto: TBitBtn
              Left = 520
              Top = 4
              Width = 90
              Height = 25
              ...
              Enabled = False
              TabOrder = 2
              OnClick = btnEliminarAdjuntoClick
              Glyph.Data = {
                36050000424D3605000000000000360400002800000010000000100000000100
                08000000000000010000E30E0000E30E00000001000000010000424242004A42
                4A0052424A004A4A4A004A524A00525252005A6352005A5A5A005A635A006363
      ...
      object DBasesor: TDBLookupComboBox
        Left = 58
        Top = 0
        Width = 247
        Height = 21
  ...
  object IBQasesor: TIBQuery
    ...
    SQL.Strings = (
        ...
        ' e.SEGUNDO_APELLIDO AS NOMBRE'
      'FROM ASESOR a'
      'INNER JOIN "gen$empleado" e ON a.ID_EMPLEADO = e.ID_EMPLEADO')
    Left = 296
    Top = 40
  end
  object CDSadjunto: TClientDataSet
    Active = True
    Aggregates = <>
    FieldDefs = <
      item
    ...
    object CDSadjuntoNombre: TStringField
      FieldName = 'Nombre'
      Size = 200
    end
    object CDSadjuntoRuta: TStringField
  ...
  object IBsolicitudtipo: TIBQuery
    Database = dmGeneral.IBDatabase1
    Transaction = IBTransaction1
    BeforeScroll = IBsolicitudtipoBeforeScroll
    SQL.Strings = (
      'SELECT * FROM SOLICITUD_TIPO')
    Left = 392
    Top = 240
  end
  object DSsolicitudtipo: TDataSource
    DataSet = IBsolicitudtipo
    Left = 416
    Top = 240
  end
end
