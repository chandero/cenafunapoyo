...
type
  TfrmReversionAbonoCartera = class(TForm)
    ...
    IBCodigo: TIBQuery;
    ExtractoTIPO_ABONO: TSmallintField;
...
//**Seleccion de Datos Necesarios
       With IBQuery1 do
        begin
          ...
          Extracto.FieldByName('TIPO_ABONO').AsInteger := 0;
          Extracto.Post;
          ...
          if not IBQuery1.Bof then
            ...
            begin
              ...
              SQL.Clear;
              SQL.Add('select ID_ESTADO from "col$causaciondiaria" where');
              SQL.Add('ID_COLOCACION =:ID_COLOCACION and FECHA_CORTE =:FECHA_CORTE');
              ParamByName('ID_COLOCACION').AsString := IdColocacion;
...
//       dmGeneral.IBTransaction1.StartTransaction;
       With IBQuery1 do
        Try
         ...
         sql.Add('"con$comprobante"."ID_AGENCIA", "con$comprobante"."TIPO_COMPROBANTE",');
         sql.Add('"con$comprobante"."FECHADIA","con$comprobante"."DESCRIPCION",');
         ...
         sql.Add(':"FECHADIA", :"DESCRIPCION", :"TOTAL_DEBITO",');
...
begin
        ...
        with IBSQL1 do begin
         ...
         SQL.Add('ID_COLOCACION =:ID_COLOCACION and ID_CBTE_COLOCACION =:ID_CBTE_COLOCACION');
