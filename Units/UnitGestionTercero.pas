...
begin
        ...
        begin
                ...
                IBQGuardar.SQL.Add('INSERT INTO "con$auxiliarterceroinicial" ');
                IBQGuardar.SQL.Add('(ID_IDENTIFICACION, ID_PERSONA, CODIGO, ANHO, SALDO_INICIAL, ID)');
                IBQGuardar.SQL.Add('VALUES (:ID_IDENTIFICACION, :ID_PERSONA, :CODIGO, :ANHO, :SALDO_INICIAL, :ID)');
                ...
                IBQGuardar.ParamByName('SALDO_INICIAL').AsCurrency := edSaldoInicial.Value;
