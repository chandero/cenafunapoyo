...
begin
 ...
 With IBQuery1 do
  begin
    ...
    Sql.Add('"col$concol".DESCRIPCION,');
    SQL.Add('"col$concol".ID_CLASE_OPERACION');
    SQL.Add('from "col$concol" Where ');
    SQL.Add('"col$concol".ID_COLOCACION =:"ID_COLOCACION"');
    ParamByName('ID_COLOCACION').AsString := Colocacion;
    Open;
    ...
    with IBAbonar do
     try
       ...
       ParamByName('DESCRIPCION').AsString := 'Desembolso de Credito Numero ' + colocacion;
       ...
       ParamByName('ID_EMPLEADO').AsString := Trim(Empleado1);
       ...
       While not IBQuery1.Eof do
        begin
          ...
          ParamByName('ID_CLASE_OPERACION').AsString := IBQuery1.FieldByName('ID_CLASE_OPERACION').AsString;
          ExecSQL;
          ...
          ParamByName('ID').AsInteger := idauxiliar;
          ParamByName('DETALLE').AsString := 'Desembolso de Crédito Numero ' + colocacion;
