...
uses
  ...
  frxClass, frxDBSet, FR_E_TXT, FR_E_RTF, frxExportPDF;
...
begin
        ...
        IBQPagina.Database := dmGeneral.IBDatabase1;
        ...
        IBQPagina.Transaction := dmGeneral.IBTransaction1;
...
procedure TfrmLibroMayorYBalance.frReport1EndPage(pgNo: Integer);
begin
        frReport1.Dictionary.Variables['PAGINA'] := _pagina;
        _pagina := _pagina + 1;
end;
