...
begin
        ...
        begin
          ...
          IBQagencia.Database := DmSolicitud.IBSolicitud1.Database;
          IBQagencia.Transaction := DmSolicitud.IBSolicitud1.Transaction;
          IBQagencia.Open;
          IBQagencia.Last;
          IBQagencia.First;

          IBQasesor.Database := DmSolicitud.IBSolicitud1.Database;
          IBQasesor.Transaction := DmSolicitud.IBSolicitud1.Transaction;
          IBQasesor.Open;
          IBQasesor.Last;
          IBQasesor.First;
...
begin
        ...
        begin
          ...
          Transaction.StartTransaction;
          SQL.Clear;
          SQL.Add('select "col$solicitud".ESTADO,"col$estadosolicitud".DESCRIPCION_ESTADO,"col$solicitud".VALOR_APROBADO, "col$solicitud".OFICINA, ASESOR.ASES_ID from "col$solicitud"');
          SQL.Add('INNER JOIN "col$estadosolicitud" ON ("col$solicitud".ESTADO = "col$estadosolicitud".ID_ESTADO)');
          SQL.Add('INNER JOIN SOLICITUDASESOR  ON ( SOLICITUDASESOR.ID_SOLICITUD = "col$solicitud".ID_SOLICITUD)');
          SQL.Add('INNER JOIN ASESOR ON (ASESOR.ASES_ID = SOLICITUDASESOR.ASES_ID)');
