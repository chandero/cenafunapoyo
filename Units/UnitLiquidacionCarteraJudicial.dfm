object frmLiquidacionCarteraJudicial: TfrmLiquidacionCarteraJudicial
  ...
  object GroupBox2: TGroupBox
    ...
    object EdCartas: TJvCurrencyEdit
      Left = 445
      Top = 121
      Width = 115
      Height = 21
    ...
    object edFecha: TDateTimePicker
      ...
      Height = 21
      CalAlignment = dtaLeft
      Date = 43425.6095797569
      Time = 43425.6095797569
      DateFormat = dfShort
      DateMode = dmComboBox
      Kind = dtkDate
      ParseInput = False
    ...
    object InfoIntereses: TTabSheet
      ...
      object GroupBox6: TGroupBox
        ...
        object Label127: TLabel
          ...
          Width = 80
          Height = 26
          Caption = 'Recuperaci'#243'n Proceso Jur'#237'dico'
          WordWrap = True
        end
        ...
        object dblAbogado: TDBLookupComboBox
          Left = 113
          Top = 168
          Width = 352
          Height = 21
  ...
  object IBQabogado: TIBQuery
    SQL.Strings = (
        ...
        'SELECT a.ID_ABOGADO, (p.NOMBRE || '#39' '#39' || p.PRIMER_APELLIDO || '#39' ' +
        #39' || p.SEGUNDO_APELLIDO) AS NOMBRE, a.ID_IDENTIFICACION, a.ID_PE' +
        'RSONA FROM "gen$abogados" a '
      
        'LEFT JOIN "gen$persona" p on a.ID_IDENTIFICACION = p.ID_IDENTIFI' +
        'CACION and a.ID_PERSONA = p.ID_PERSONA')
    Left = 472
    Top = 520
  end
