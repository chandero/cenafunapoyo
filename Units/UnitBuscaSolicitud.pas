...
begin
          ...
          FrmInformacion.DBasesor.KeyValue := asesor;
...
begin
        ...
        begin
          ...
          SQL.Add('SELECT');
          SQL.Add('s.OFICINA,');
          SQL.Add('s.ID_SOLICITUD,');
          SQL.Add('s.ID_IDENTIFICACION,');
          SQL.Add('s.ESTADO,');
          SQL.Add('s.ID_PERSONA,');
          SQL.Add('s.OBSERVACION,');
          SQL.Add('s.FECHA_RECEPCION,');
          SQL.Add('a.ASES_ID');
          SQL.Add('FROM');
          ...
          SQL.Add('AND (s.ESTADO in (1,13,9))');
          ...
          begin
            ...
            asesor := FieldByName('ASES_ID').AsInteger;
