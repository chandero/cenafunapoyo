...
begin
        ...
        for i := 1 to 12 do
          with IBSQL2 do begin
            Close;
            SQL.Clear;
            SQL.Add('select * from "con$saldoscuenta" where ');
...
begin
        ...
        Dmpuc.IBDataSetinformes.last;
        Dmpuc.IBDataSetinformes.first;
...
begin
      ...
      Dmcomprobante.ibqsetagencia.Last;
      Dmcomprobante.ibqsetagencia.First;
      creararbol;
      BtnLimpiar.Click;
