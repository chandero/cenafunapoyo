object frmLibroMayorYBalance: TfrmLibroMayorYBalance
  ...
  object IBQPagina: TIBQuery
    SQL.Strings = (
      'SELECT * FROM CON$LIBROREGISTRADO WHERE LIRE_ID = 1')
    Left = 128
    Top = 24
  end
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.CreateDate = 43521.3708923264
    ReportOptions.LastChange = 43521.4791640509
