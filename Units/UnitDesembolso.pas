...
uses                                                  
  ...
  frRtfExp, pr_TxClasses, DateUtils, JclDateTime, Provider, NLetra;
...
type
  TFrmDesembolso = class(TForm)
    ...
    IBQListAsesor: TIBQuery;
    Label16: TLabel;
    edCentroAgencia: TDBLookupComboBox;
    IBQagencia: TIBQuery;
    DSagencia: TDataSource;
    Panel5: TPanel;
    Label22: TLabel;
    DBListAsesor: TDBLookupComboBox;
    lblAsesor: TLabel;
    NLetra1: TNLetra;
    edFechaRecursos: TDateTimePicker;
    Label23: TLabel;
    Label24: TLabel;
    edInteresCobrar: TJvCurrencyEdit;
    ...
    procedure edFechaRecursosKeyPress(Sender: TObject; var Key: Char);
    procedure edFechaRecursosChange(Sender: TObject);
    procedure edFechaRecursosExit(Sender: TObject);
  private
    vvalorpuntos: single;
...
var
  ...
  ValorInteresCobrar: Currency;
  EsAnulado : Integer;
  EsVigente : Integer;
  Empleado1 : string;
  vFechaPago :TDate;
  vFechaRecursos: TDate;
...
begin
        ...
        IBQAsesor.Transaction := IBTSolicitud;
        IBQListAsesor.Database := dmGeneral.IBDatabase1;
        IBQListAsesor.Transaction := dmGeneral.IBTransaction1;

        IBQagencia.Database := dmGeneral.IBDatabase1;
        IBQagencia.Transaction := IBTSolicitud;
...
begin
        ...
        begin
        {
          ...
          begin
            ...
            SQL.Add('SOLICITUDASESOR.ASES_ID');
            SQL.Add('FROM');
            ...
            SQL.Add('LEFT JOIN SOLICITUDASESOR ON (SOLICITUDASESOR.ID_SOLICITUD = "col$solicitud".ID_SOLICITUD)');
            SQL.Add('WHERE');
            ...
            vAgencia := FieldByName('OFICINA').AsInteger;
...
//            EdCuentaAportes.Caption := IntToStr(vCtaAportes);
            ...
            IBQagencia.Last;
            IBQagencia.First;
            edCentroAgencia.KeyValue := FieldByName('OFICINA').AsInteger;


            IBQListAsesor.Open;
            IBQListAsesor.Last;
            IBQListAsesor.First;
            vAsesor := FieldByName('ASES_ID').AsInteger;
            DBListAsesor.KeyValue := vAsesor;
            ...
            begin
                ...
                SQL.Add('("col$registrosesion".ESTADO = 16) ');
                ParamByName('ID_SOLICITUD').AsString := vIdSolicitud;
                ExecQuery;
            ...
            begin
               ...
               IBcdat.Close;
               IBcdat.SQL.Clear;
               IBcdat.SQL.Add('select * from "col$datogarantia" where MATRICULA = :MATRICULA');
...
<<<<<<< HEAD
            ...
            Close;
            SQL.Clear;
            SQL.Add('SELECT VALOR_APORTE FROM COL$SOLICITUDAPORTE WHERE ID_SOLICITUD = :ID_SOLICITUD');
            ParamByName('ID_SOLICITUD').AsString := vIdSolicitud;
            ExecQuery;
            if FieldByName('VALOR_APORTE').AsCurrency <= 0 then
             EdValorAporte.Value := 0
            else
...
//        IBDStipocuota.First;
        ...
        edFechaRecursos.Date := vFechaDesembolso;
        vTipoTasa := 'F';
            ...
            begin
              ...
              begin
                ...
                begin
                  ...
                  begin
                    Append;
                    FieldValues['id_agencia'] := IBSQL2.FieldByName('ID_AGENCIA').AsInteger;
...
<<<<<<< HEAD
        valorAporte := 0;
            ...
            IBSQL4.ParamByName('ID_COLOCACION').AsString := VidColocacion;
            IBSQL4.ExecQuery;
...
>>>>>>> 171925b3cf59501bab9dd1664befb26ff80c6cee
        ...
        begin
             SQL.Clear;
             SQL.Add('select "col$concol".ID_AGENCIA, "col$concol".ID_COLOCACION,"col$concol"."CODIGO","con$puc".NOMBRE,"col$concol".DEBITO,"col$concol".CREDITO,"col$concol".DESCRIPCION');
             SQL.Add(' FROM "col$concol" left join "con$puc" ON ');
             SQL.Add('("col$concol"."CODIGO" = "con$puc"."CODIGO") ');
             SQL.Add('where ("col$concol".ID_COLOCACION = :"ID_COLOCACION") ORDER BY "col$concol".CREDITO,"col$concol"."CODIGO"');
             ParamByName('ID_COLOCACION').AsString := vIdColocacion;
             Open;
        end;
        ...
        begin
           ...
           SQL.Add('INNER JOIN "col$garantiacol" ON ("col$datogarantia".MATRICULA = "col$garantiacol".MATRICULA)');
           SQL.Add('WHERE');
...
begin
        ...
        if LowerCase(ParName) = 'agencia' then
           ParValue := edCentroAgencia.Text;
        if ParName = 'de' then
           ParValue := lugar_identificacion;
        if LowerCase(ParName) = 'nit' then
           ParValue := Nit;
...
>>>>>>> 171925b3cf59501bab9dd1664befb26ff80c6cee
        ...
        begin
           with dmColocacion.IBQuery do begin
            ...
            SQL.Add('"DEBITO","CREDITO","FECHA_Y_HORA", "DESCRIPCION", "ID_CLASE_OPERACION") values (');
            SQL.Add(':"ID_AGENCIA", :"ID_COLOCACION",');
            SQL.Add(':"CODIGO", :"DEBITO", :"CREDITO",');
            SQL.Add(':"FECHA_Y_HORA", :"DESCRIPCION", :"ID_CLASE_OPERACION")');
            ParamByName('ID_AGENCIA').AsInteger := vAgencia;
            ParamByName('ID_COLOCACION').AsString := vIdColocacion;
            ...
            ParamByName('DESCRIPCION').AsString := 'Donacion patrimonial para que con su reinversión permanente en desarrollo de su objeto social la Fundacion Apoyo desarrolle la actividad de apoyo a la educacion y fomento empresarial';
...
>>>>>>> 171925b3cf59501bab9dd1664befb26ff80c6cee
        ...
        begin
           with dmColocacion.IBQuery do begin
            ...
            ParamByName('FECHA_Y_HORA').AsDateTime := vfechahora;
            ParamByName('DESCRIPCION').AsString := 'Desembolso de Credito Numero ' + vIdColocacion ;
            ParamByName('ID_CLASE_OPERACION').AsString := '';
            ExecSQL;
            Close;
        ...
        begin
           with dmColocacion.IBQuery do begin
            ...
            ParamByName('ID_AGENCIA').AsInteger := vAgencia;
            ParamByName('ID_COLOCACION').AsString := vIdColocacion;
            ParamByName('CODIGO').AsString := recupera_codigo(64);
            ParamByName('DEBITO').AsCurrency := 0;
            ParamByName('CREDITO').AsCurrency := ValorInteresCobrar;
            ParamByName('FECHA_Y_HORA').AsDateTime := vfechahora;
            ParamByName('DESCRIPCION').AsString := 'Desembolso de Credito Numero ' + vIdColocacion ;
            ParamByName('ID_CLASE_OPERACION').AsString := '';
            ExecSQL;
            Close;
            vCaja := vCaja - ValorInteresCobrar;
          end;
        end;
        ...
        begin
            ...
            SQL.Add(' where (ID_COLOCACION = :"ID_COLOCACION") ORDER BY FECHA_A_PAGAR');
            ParamByName('ID_COLOCACION').AsString := vIdColocacion;
            Open;
            Last;
            First;
           ...
           with dmColocacion.IBDScontable do
            begin
              ...
              begin
                 ...
                 FieldByName('ID_AGENCIA').AsInteger := vAgencia;
                 ...
                 FieldByName('DESCRIPCION').AsString := 'Desembolso de Credito Numero ' + vIdColocacion ;
                 FieldByName('ID_CLASE_OPERACION').AsString := '';
                 Post;
              end;
            ...
            if vDescuento > 0 then begin
              with IBSQL2 do
               begin
                 ...
                 SQL.Clear;
                 SQL.Add('insert into "col$concol" ("ID_AGENCIA","ID_COLOCACION","CODIGO",');
                 SQL.Add('"DEBITO","CREDITO","FECHA_Y_HORA","DESCRIPCION") values (');
                 SQL.Add(':"ID_AGENCIA", :"ID_COLOCACION",');
                 SQL.Add(':"CODIGO", :"DEBITO", :"CREDITO",');
                 SQL.Add(':"FECHA_Y_HORA",:"DESCRIPCION")');
                 ParamByName('ID_AGENCIA').AsInteger := vAgencia;
                 ParamByName('ID_COLOCACION').AsString := vIdColocacion;
...
{Busco Codigo Ahorros y Aplico Valor Ahorros}
           ...
           dmColocacion.IBDScontable.FieldByName('ID_AGENCIA').AsInteger := vAgencia;
           ...
           dmColocacion.IBDScontable.FieldByName('DESCRIPCION').AsString := 'Desembolso de Credito Numero ' + vIdColocacion ;
           dmColocacion.IBDScontable.FieldByName('ID_CLASE_OPERACION').AsString := '2.2.1';
...
{Busco Codigo Capitalización y Aplico Valor Capitalizacion}
           ...
           if vDctoCapitalizacion > 0 then
            begin
              ...
              dmColocacion.IBDScontable.FieldByName('DESCRIPCION').AsString := 'Desembolso de Credito Numero ' + vIdColocacion ;
              dmColocacion.IBDScontable.FieldByName('ID_CLASE_OPERACION').AsString := '';              
              dmColocacion.IBDScontable.Post;
            end;
...
begin
   with IBSQL2 do begin
     ...
     ParamByName('AG').AsInteger := vAgencia;
...
//credito no visado por defecto
           ...
           // Insertar en colocacionasesor
           try
             IBQasesor.Close;
             IBQAsesor.SQL.Clear;
             IBQAsesor.SQL.Add('INSERT INTO COLOCACIONASESOR (ID_COLOCACION, ASES_ID) VALUES (:ID_COLOCACION, :ASES_ID)');
             IBQAsesor.ParamByName('ID_COLOCACION').AsString := VidColocacion;
             IBQAsesor.ParamByName('ASES_ID').AsInteger := DBListAsesor.KeyValue;
             IBQAsesor.ExecSQL;
           except
              Showmessage('Error insertando en COLOCACION_ASESOR');
              Result := false;
              dmGeneral.IBTransaction1.Rollback;
           end;
<<<<<<< HEAD
           ...
           try
             ...
             begin
               SQL.Clear;
               SQL.Add('INSERT INTO COL$APORTEVINCULADO VALUES (:ID_COLOCACION, :FECHA_REGISTRO, :APORTE, :PLAZO)');
               ParamByName('ID_COLOCACION').AsString := VidColocacion;
               ParamByName('FECHA_REGISTRO').AsDate := vFechaDesembolso;
               ParamByName('APORTE').AsCurrency := vAportes;
               ParamByName('PLAZO').AsInteger := vPlazo div vAmortizaInteres;
               ExecSQL;
             end;
           except
              Showmessage('Error insertando APORTE VINCULADO');
              Result := false;
              dmGeneral.IBTransaction1.Rollback;
           end;
           ...
           begin
               with dmColocacion.IBQuery do
                begin
                  ...
                  ParamByName('FECHA_Y_HORA').AsDateTime := vFechaHora;
                  ParamByName('DESCRIPCION').AsString := 'Desembolso de Credito Numero ' + vColocacion ;
                  ParamByName('ID_CLASE_OPERACION').AsString := '';
                  Open;
                end;
            Next;
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              SQL.Add('from "col$colgarantias"');
              SQL.Add('inner join "col$colocacion" ON "col$colocacion".ID_COLOCACION = "col$colgarantias".ID_COLOCACION)');
              SQL.Add('inner join "col$estado" ON ("col$colocacion".ID_ESTADO_COLOCACION = "col$estado".ID_ESTADO_COLOCACION)');
              SQL.Add('left join "gen$persona" ON ( "col$colocacion".ID_IDENTIFICACION = "gen$persona".ID_IDENTIFICACION and "col$colocacion".ID_PERSONA = "gen$persona".ID_PERSONA)');
              SQL.Add('where "col$colgarantias".ID_PERSONA = :ID_PERSONA AND');
              SQL.Add('"col$colgarantias".ID_IDENTIFICACION = :ID_IDENTIFICACION and');
              ...
              begin
                ...
                begin
                  dias := obtenerdeudahoy1(vAgencia,FieldByName('ID_COLOCACION').AsString,IBSQL8).Dias;
...
begin
        ...
        begin
          ...
          Close;
          SQL.Clear;
          SQL.Add('insert into "col$desembolso" (ID_AGENCIA,ID_COLOCACION,HORA_DESEMBOLSO, ID_EMPLEADO_VISADOR, ID_SOLICITUD)');
          SQL.Add('values (:ID_AGENCIA, :ID_COLOCACION, :HORA_DESEMBOLSO, :ID_EMPLEADO_VISADOR, :ID_SOLICITUD)');
          ParamByName('ID_AGENCIA').AsInteger := vAgencia;
          ParamByName('ID_COLOCACION').AsString := VidColocacion;
          ParamByName('HORA_DESEMBOLSO').AsTime :=  fHoraActual;
          ParamByName('ID_EMPLEADO_VISADOR').AsString := '';
          ParamByName('ID_SOLICITUD').AsString := DBsolicitud.Text;
          ExecSQL;
          Transaction.Commit;
        end;
           ...
           begin
             ...
             begin
                ...
                begin
                  ...
                  IBQuery3.ParamByName('ID_AGENCIA').AsInteger := vAgencia;
                  IBQuery3.ExecSQL;
                  Next;
                end;
...
begin
        ...
        vFechaPago := vFechaDesembolso;
        edFechaRecursos.Date := vFechaDesembolso;
        vFechaRecursos := vFechaDesembolso;
      //  EdFechaPago.MinDate := vFechaDesembolso;
end;

procedure TFrmDesembolso.edFechaRecursosKeyPress(Sender: TObject;
  var Key: Char);
begin
        EnterTabs(Key,Self)
end;

procedure TFrmDesembolso.edFechaRecursosChange(Sender: TObject);
begin
        edFechaRecursosExit(sender);
end;

procedure TFrmDesembolso.edFechaRecursosExit(Sender: TObject);
begin
        //
        vFechaRecursos := edFechaRecursos.Date;
        vDiasInteresCobrar := DiasEntre(vFechaRecursos, vFechaPago);
        ValorInteresCobrar := SimpleRoundTo(vDesembolso * vTasaNominal / 100 / 360 * vDiasInteresCobrar, 0);
        edInteresCobrar.Value := ValorInteresCobrar;
end;
